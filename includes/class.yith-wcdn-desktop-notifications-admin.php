...
if ( !class_exists( 'YITH_WCDN_Desktop_Notifications_Admin' ) ) {
    ...
    class YITH_WCDN_Desktop_Notifications_Admin {
         ...
         */
        protected $_official_documentation = 'https://yithemes.com/docs-plugins/yith-desktop-notifications-for-woocommerce/';
        ...
        public function __construct() {
            ...
            add_filter( 'yith_plugin_fw_banners_free', array( $this, 'set_upgrade_link' ) );
        ...
        public function set_upgrade_link( $banners ) {

            if( is_array($banners) ) {

                $banners['upgrade']['link'] = 'https://yithemes.com/themes/plugins/yith-woocommerce-desktop-notifications/';
            }
        ...
        {
            return $this->_premium_landing_url ;
        }
