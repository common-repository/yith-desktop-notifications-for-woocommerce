    ...
    <div class="section section-cta section-odd">
        <div class="landing-container">
            <div class="premium-cta">
                <p>
                    <?php echo sprintf( esc_html__('Upgrade to %1$spremium version%2$s of %1$sYITH Desktop Notifications for WooCommerce%2$s to benefit from all features!','yith-desktop-notifications-for-woocommerce'),'<span class="highlight">','</span>' );?>
                </p>
    ...
    <div class="one section section-even clear">
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                ...
                <p>
                    <?php echo sprintf(esc_html__('%1$sWhy limiting it to notify you only about new orders?%2$s', 'yith-desktop-notifications-for-woocommerce'), '<b>', '</b>');?>
                </p>
                <p>
                    <?php echo sprintf(esc_html__('With the premium version of the plugin, you can enable the notifications also for the following actions:', 'yith-desktop-notifications-for-woocommerce'), '<b>', '</b>');?>
                </p>
                <ul>
                    <li>
    ...
    <div class="two section section-odd clear">
        <div class="landing-container">
            <div class="col-2">
                ...
                <p>
                    <?php echo sprintf(esc_html__('You can edit the body of each notification as you prefer by inserting %1$stitle%2$s and %1$sdescription%2$s to suit better your notices. .', 'yith-desktop-notifications-for-woocommerce'), '<b>', '</b>','<br>');?>
                </p>
                <p>
                    <?php echo sprintf(esc_html__('And that’s not all! By associating an %1$sicon%2$s and a %1$ssound%2$s to the messages when they are shown, they will stand out even more.  ', 'yith-desktop-notifications-for-woocommerce'), '<b>', '</b>','<br>');?>
                </p>
            </div>
            <div class="col-1">
    ...
    <div class="four section section-odd clear">
        <div class="landing-container">
            <div class="col-2">
                ...
                <p>
                    <?php echo sprintf(esc_html__('For %1$show long do you want to show%2$s the notification?', 'yith-desktop-notifications-for-woocommerce'), '<b>', '</b>');?>
                </p>
                <p>
                    <?php echo sprintf(esc_html__('There are two options: remove it only when it was selected or hide it automatically at the end of the configured time span.', 'yith-desktop-notifications-for-woocommerce'), '<b>', '</b>');?>
                </p>
            </div>
            <div class="col-1">
